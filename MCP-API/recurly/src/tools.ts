...
export const TOOLS: ToolDef[] = [
  { name:"recurly.account.list", description:"List customer accounts with bounded pagination.", risk:"READ", schema:obj({...page}), inputSchema:jsonSchema({limit:{...n,minimum:1,maximum:200},cursor:s}) },
  ...
  { name:"recurly.subscription.list", description:"List subscriptions with bounded pagination.", risk:"READ", schema:obj({...page}), inputSchema:jsonSchema({limit:{...n,minimum:1,maximum:200},cursor:s}) },
  ...
  { name:"recurly.subscription.cancel", description:"Cancel a subscription at the next bill date or term end; this changes future billing.", risk:"HIGH_RISK", schema:obj({subscriptionId:id,timeframe:z.enum(["bill_date","term_end"]),...approval}), inputSchema:jsonSchema({subscriptionId:s,timeframe:{type:"string",enum:["bill_date","term_end"]},approved:b},["subscriptionId","timeframe"]) },
  ...
  { name:"recurly.invoice.list", description:"List invoices with bounded pagination.", risk:"READ", schema:obj({...page}), inputSchema:jsonSchema({limit:{...n,minimum:1,maximum:200},cursor:s}) },
  ...
  { name:"recurly.plan.list", description:"List plans for catalog discovery with bounded pagination.", risk:"READ", schema:obj({...page}), inputSchema:jsonSchema({limit:{...n,minimum:1,maximum:200},cursor:s}) },
  { name:"recurly.transaction.list", description:"List payment transactions for support and reconciliation workflows with bounded pagination.", risk:"READ", schema:obj({...page}), inputSchema:jsonSchema({limit:{...n,minimum:1,maximum:200},cursor:s}) }
];
