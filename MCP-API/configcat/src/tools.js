...
export const tools=[
 ...
 ['configcat.audit.list','READ',z.object({productId:id,limit:z.number().int().min(1).max(100).default(50)}).strict(),a=>['GET',`/v1/products/${a.productId}/auditlogs`,{limit:a.limit}]],
